      ...
      {windowWidth > 640 ? ( // Show sidebar on larger screens
        <>
          ...
          <aside
            ...
            className="fixed top-0 right-0 z-40 w-64 h-screen transition-transform -translate-y-full sm:translate-y-0 md:w-48 "
            aria-label="Sidebar"
          >
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
              {showProfile ? (
                <button
                  ...
                  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 group"
                >
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                    aria-hidden="true"
